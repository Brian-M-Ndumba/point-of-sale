...
<head>
	...
	<?php } ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=9c37dea34e"></script>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-center" style="text-align:center">
					...
					<!-- <strong><?php echo "Improving Agriculture, Improving Lifes"; ?></strong> -->
				</div>
			</div>
		</div>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">XJAgrovet</a>
				</div>
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<?php foreach($allowed_modules as $module):?>
							...
							<!-- remove the unnecessary buttons on the page -->
							<?php if( $module->module_id != "item_kits" && $module->module_id != "giftcards" && $module->module_id != "messages" &&  $module->module_id != "cashups"):?>
